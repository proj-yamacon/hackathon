...
class ZonesControllerTest < ActionController::TestCase
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post :create, zone: { current_temperature: @zone.current_temperature, target_temperature: @zone.target_temperature, zone_name: @zone.zone_name }
    end
  ...
  test "should update zone" do
    patch :update, id: @zone, zone: { current_temperature: @zone.current_temperature, target_temperature: @zone.target_temperature, zone_name: @zone.zone_name }
    assert_redirected_to zone_path(assigns(:zone))
  end
